...
#tranform dependent variable into binary 0/1 to enable bernoulli trial mode in gbm
train$Party=ifelse(train$Party=="Democrat",0, 1)

#as always use the top features in terms of p-value significance  
...
#tranform dependent variable into binary Democrat/Republican
